...
import { DiscussionCanvas } from '@pm/components/DiscussionCanvas'
import { VoiceTab } from '@pm/components/VoiceTab'
import { GrowthTab } from '@pm/components/GrowthTab/GrowthTab'
import { DecisionTab } from '@pm/components/DecisionTab/DecisionTab'
import { StoryTab } from '@pm/components/StoryTab/StoryTab'
import { PlanningTab } from '@pm/components/PlanningTab/PlanningTab'
import { HumanExecutionTab } from '@pm/components/HumanExecutionTab/HumanExecutionTab'
import { AIExecutionTab } from '@pm/components/AIExecutionTab/AIExecutionTab'
import { SyncBackTab } from '@pm/components/SyncBackTab/SyncBackTab'
import { AttendeePanel } from '@pm/components/AttendeePanel/AttendeePanel'
import { PermissionMatrixPanel } from '@pm/components/PermissionMatrix/PermissionMatrixPanel'
import { PhaseNavigator } from '@pm/components/PhaseNavigator'
import { AutoTransitionToast } from '@pm/components/PhaseNavigator/AutoTransitionToast'
...
import { PHASE_TRANSITION_RULES, PHASE_ORDER, PHASE_LABELS, PHASE_LABELS_EN, getNextPhase } from '@pm/config/phaseTransitionRules'
import { checkPhaseConditions } from '@pm/utils/checkPhaseConditions'
import uc1Fixture from '@pm/mocks/fixtures/uc1-churn-risk-acme.json'
import uc2Fixture from '@pm/mocks/fixtures/uc2-api-gateway-incident.json'
import uc3Fixture from '@pm/mocks/fixtures/uc3-enterprise-upsell.json'
import uc4Fixture from '@pm/mocks/fixtures/uc4-pmf-feature-pivot.json'
import uc5Fixture from '@pm/mocks/fixtures/uc5-beachhead-vertical.json'
import uc6Fixture from '@pm/mocks/fixtures/uc6-pricing-emea.json'
import type { MeetingBundle, Phase } from '@pm/types/agenda'
import type { VoiceItem } from '@pm/types/voice'
import type { GHSItem } from '@pm/types/growth'
import type { DecisionItem } from '@pm/types/decision'
...
import { gdiosToMeetingBundle } from '@pm/utils/gdiosToMeetingBundle'
